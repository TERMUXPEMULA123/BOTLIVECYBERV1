...
const vcard = 'BEGIN:VCARD\n' // ANAK ANJING MAU NGAPAIN ASU!?
            ...
            + 'FN:OWNER\n' // NAMA OWNER BOT
            + 'ORG:Creator LIVE CYBER;\n' // KASIH CREDITS GUA FADHIL GRAPHY SU!!!
            + 'TEL;type=CELL;type=VOICE;waid=6282269316262:+62 822-6931-6262\n' // GANTI NOMOR LU
            + 'END:VCARD'
prefix = '/'
blocked = []
...
async function starts() {
	...
	client.on('message-new', async (mek) => {
		try {
			...
			const ownerNumber = ["6282269316262@s.whatsapp.net"] // GANTI NOMOR LU
			const adminbotnumber = ["6282269316262@s.whatsapp.net"] // GANTI NOMOR LU
			...
			case 'owner':
               ...
               client.reply(from, `Waalaikumsalam ${pushname}:)`)
                ...
                case 'report':
                    ...
                    client.sendMessage('6282269316262@s.whatsapp.net', options, text, {quoted: mek})
